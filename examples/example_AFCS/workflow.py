...
ic0 = Interconnect(name='c1a_c1b',
                   ...
                   component_1_port_index=c1a.port_indices['right'],
                   component_2_name='radiator_and_ion_exchanger_1b',
                   component_2_port_index=c1b.port_indices['left'],
                   radius=0.05,
...
ic1 = Interconnect(name='c1b_c2b',
                   ...
                   component_1_port_index=c1b.port_indices['right'],
                   component_2_name='pump_2b',
                   component_2_port_index=c2b.port_indices['top'],
                   radius=0.05,
                   number_of_waypoints=0,
                   degrees_of_freedom=())
...
ic2 = Interconnect(name='c2b_c3b',
                   color='black',
                   component_1_name='pump_2b',
                   component_1_port_index=c2b.port_indices['bottom'],
                   component_2_name='particle_filter_3b',
                   component_2_port_index=c3b.port_indices['top'],
                   radius=0.05,
                   number_of_waypoints=0,
                   degrees_of_freedom=())
...
ic3 = Interconnect(name='c3b_c4b',
                   color='black',
                   component_1_name='particle_filter_3b',
                   component_1_port_index=c3b.port_indices['bottom'],
                   component_2_name='fuel_cell_stack_4b',
                   component_2_port_index=c4b.port_indices['top'],
                   radius=0.05,
                   number_of_waypoints=0,
                   degrees_of_freedom=())
...
ic4 = Interconnect(name='c4b_c5',
                   color='black',
                   component_1_name='fuel_cell_stack_4b',
                   component_1_port_index=c4b.port_indices['bottom'],
                   component_2_name='WEG_heater_and_pump_5',
                   component_2_port_index=c5.port_indices['top'],
                   radius=0.05,
                   number_of_waypoints=0,
                   degrees_of_freedom=())
...
ic5 = Interconnect(name='c5_c6',
                   color='black',
                   component_1_name='WEG_heater_and_pump_5',
                   component_1_port_index=c5.port_indices['left'],
                   component_2_name='heater_core_6',
                   component_2_port_index=c6.port_indices['right'],
                   radius=0.05,
                   number_of_waypoints=0,
                   degrees_of_freedom=())
...
ic6 = Interconnect(name='c6_c4a',
                   color='black',
                   component_1_name='heater_core_6',
                   component_1_port_index=c6.port_indices['left'],
...
ic7 = Interconnect(name='c4a_c3a',
                   color='black',
                   component_1_name='fuel_cell_stack_4a',
                   component_1_port_index=c4a.port_indices['top'],
                   component_2_name='particle_filter_3a',
                   component_2_port_index=c3a.port_indices['bottom'],
                   radius=0.05,
                   number_of_waypoints=0,
                   degrees_of_freedom=())
...
ic8 = Interconnect(name='c3a_c2a',
                   color='black',
                   component_1_name='particle_filter_3a',
                   component_1_port_index=c3a.port_indices['top'],
                   component_2_name='pump_2a',
                   component_2_port_index=c2a.port_indices['top'],
                   radius=0.05,
                   number_of_waypoints=0,
                   degrees_of_freedom=())
...
ic9 = Interconnect(name='c2a_c1a',
                   color='black',
                   component_1_name='pump_2a',
                   component_1_port_index=c2a.port_indices['top'],
                   component_2_name='radiator_and_ion_exchanger_1a',
                   component_2_port_index=c1a.port_indices['left'],
                   radius=0.05,
                   number_of_waypoints=0,
                   degrees_of_freedom=())
