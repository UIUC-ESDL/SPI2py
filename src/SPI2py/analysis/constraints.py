...
import numpy as np
from .distance import minimum_distance_points_points
...
def signed_distances(x, spatial_configuration, pairs):
    ...
    for obj1, obj2 in pairs:
        ...
        dPositions = minimum_distance_points_points(positions_a, positions_b)
        dRadii     = minimum_distance_points_points(radii_a.reshape(-1, 1), radii_b.reshape(-1, 1))
