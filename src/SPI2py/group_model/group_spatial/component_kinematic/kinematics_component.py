...
class KinematicsComponent(ExplicitComponent):
    ...
    def setup(self):
        ...
        self.kinematic_interface = KinematicsInterface(components=components,
                                                       interconnects=interconnects)

        x_default = self.kinematic_interface.design_vector
    ...
    def compute(self, inputs, outputs):
        ...
        f = self.kinematic_interface.calculate_objective(x)
        g = self.kinematic_interface.calculate_constraints(x)
