...
mux_centers = Multiplexer(n_i=[122, 1119, 195], m=3)  # , 3, 3, 3, 3, 3, 3], m=3)
mux_radii = Multiplexer(n_i=[122, 1119, 195], m=1)  # , 3, 3, 3, 3, 3, 3], m=1)
...
plot_AABB(plotter, sp1, prob.get_val('bbv.bounds'), color='gray', opacity=0.15)
...
plot_AABB(plotter, sp3, prob.get_val('bbv.bounds'), color='gray', opacity=0.15)
