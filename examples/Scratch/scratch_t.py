...
from SPI2py.models.physics.distributed.assembly import assemble_global_system_partition, apply_bc_partition
...
print("Maximum temperature: ", jnp.max(u_unordered))
print("Minimum temperature: ", jnp.min(u_unordered))
